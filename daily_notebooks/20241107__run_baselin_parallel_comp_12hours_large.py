...
if __name__ == '__main__':
    ...
    np.save(f'{Path(__file__).parent}/20241107__medium_160gb_baseline_8p1c1t_estimates.npy', baseline_estimates)
    ...
    np.save(f'{Path(__file__).parent}/20241108__medium_160gb_parallel_8p1c1t_estimates.npy', parallel_estimates)
