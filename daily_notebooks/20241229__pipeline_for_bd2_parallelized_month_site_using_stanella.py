...
if __name__ == '__main__':
    ...
    cfg['duration'] = 1795
    cfg["output_dir"] = Path(f'{Path.home()}/Documents/bd2_dets_20241229_thresh0p00/output_dir')
    cfg["tmp_dir"] = Path(f'{Path.home()}/Documents/bd2_dets_20241229_thresh0p00/output')
